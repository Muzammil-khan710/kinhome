...
const OurProcess = (props:Props) => {
    return(
        <section className="text-center py-20">
            {/* <div className="w-screen object-cover object-center relative"> */}
                {/* <Image src="/family.jpeg" layout="fill" objectFit="cover" objectPosition='center'  alt="family image" /> */}
                <img className="object-cover object-center" src="/family.jpeg"  alt="family image" />
            {/* </div> */}
